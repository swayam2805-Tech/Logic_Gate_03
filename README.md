# Logic Gates (NAND Gate using Verilog)

## Project Overview

This project demonstrates the implementation of a **basic NAND logic gate** using **Verilog HDL**. It is intended for **learners and developers** who want hands-on experience with digital logic design and FPGA implementation.

The repository includes:

* Verilog **design file** for the NAND gate 
...
* Learn how to write a simple NAND gate in Verilog
...
This waveform verifies the correct functionality of the NAND gate using the testbench.
![Waveform Simulation](Waveform.png)


### Design Schematic

Schematic view generated in Xilinx Vivado showing the nAND gate logic.
...
## Project Status
 ...
 NAND gate implemented and tested successfully
 Future scope: NOT, NOR, XOR gates
